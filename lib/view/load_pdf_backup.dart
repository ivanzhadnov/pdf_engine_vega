...
//                         onTap: () => onTap(index),
//                         //onPanStart: (v) => null,
//                         //onPanEnd: (v) => !zoomInProgress ? onPanEnd(v, index, setState) : null,
//                         //onPanUpdate: (details) => !zoomInProgress ? onPanUpdate(details, index, setState) : null,
...
//                               child: Stack(
//                                   children: [
//                                     Image.memory(_snapshot.data!.first,),
